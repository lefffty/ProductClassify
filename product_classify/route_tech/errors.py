...
class GWCErrors(StrEnum):
    ...
    INVALID_PLACE = (
        "Количество рабочих мест должно быть положительным целым числом (больше нуля)."
    )
...
class ProdOperErrors:
    ...
    INVALID_NUM_OF_WORKERS = "Количество исполнителей, занятых при выполнении операции, должно быть положительным целым числом (больше нуля)."
