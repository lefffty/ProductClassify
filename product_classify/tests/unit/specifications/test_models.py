...
class ProdComponentTest(BaseUnitTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.component = ProdFactory(
            class_field=cls.nuts_subclass,
            ei=cls.base_ei,
            cost=400,
            image=None,
        )
        cls.prodcomponent1 = ProdComponentFactory(
...
class SpecificationLogsTest(BaseUnitTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.logs1 = SpecificationLogsFactory(
    ...
    def test_string_representation(self):
        ...
        expected_representation = (
            f"Количество изделия {self.component.name} "
            f"изменилось с {12} на {24}"
        )
        self.assertEqual(actual_representation, expected_representation)
